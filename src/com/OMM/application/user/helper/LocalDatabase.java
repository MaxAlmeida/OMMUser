...
public class LocalDatabase extends SQLiteOpenHelper {
	...
	private static String tabela_parlamentar = "CREATE TABLE [PARLAMENTAR] " +
			"([ID_PARLAMENTAR] VARCHAR(10),[NOME_PARLAMENTAR] VARCHAR(40)," +
			"[PARTIDO] VARCHAR(25), [UF] VARCHAR(2), [VALOR] DOUBLE, " +
			"[SEGUIDO] BOOLEAN,[FOTO] VARBINARY, " +
			"[RANKING_POS] VARCHAR(10));";
	
	private static String tabela_cota = "CREATE TABLE [COTA] (  [ID_COTA] VARCHAR(10)," +
			"[ID_PARLAMENTAR] VARCHAR(10),[NUM_SUBCOTA] INT(10),[DESCRICAO] VARCHAR(40) ,  [MES] INTEGER,  [ANO] INTEGER, [VALOR] DOUBLE);";
