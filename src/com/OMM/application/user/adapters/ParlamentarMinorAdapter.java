...
public class ParlamentarMinorAdapter extends ArrayAdapter<Parlamentar> {

	private Context context;
	private List<Parlamentar> parlamentares;

	public ParlamentarMinorAdapter(Context context, int textViewResourceId,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		textViewPosicao.setText("" + (Math.abs(parlamentares.get(position).getRanking()-515)+ 1));
